...
var hiprint = function (t) {
      ...
      return TableExcelHelper.createTableHead = function (t, e) {
        ...
        (e || (e = []), groupFields.length) ? _assets_plugins_hinnn__WEBPACK_IMPORTED_MODULE_1__.a.groupBy(e, groupFields, function (t) {
          ...
          if (groupData.rows.forEach(function (t, rowIndex) {
            fullRowIndex=fullRowIndex+1
            var e = TableExcelHelper.createRowTarget(o, t, n, i, rowIndex, groupData.rows, printData,fullRowIndex,visibleData);
            r.append(e);
          ...
          var row = TableExcelHelper.createRowTarget(o, t, n, i, rowIndex, e, printData,rowIndex,visibleData);
          r.append(row);
        });
        return r;
      }, TableExcelHelper.createRowTarget = function (t, e, n, i, rowIndex, tableData, printData,fullRowIndex,visibleData) {
        var o = $("<tr></tr>");
        ...
        o.data("rowData", e), t.rowColumns.filter(function (t) {
          ...
          if (n.rowsColumnsMerge) {
            ...
            var rowsColumnsArr = rowsColumnsMerge(e, t, i, rowIndex, tableData, printData,fullRowIndex,visibleData) || [1, 1]
  ...
  var i = function () {
    ...
    rowcolumns = function () {
      ...
      return t.prototype.createTarget = function () {
        return this.target = $(' <div class="hiprint-option-item hiprint-option-item-row">\n        <div class="hiprint-option-item-label">\n        行/列合并函数\n        </div>\n        <div class="hiprint-option-item-field">\n        <textarea style="height:80px;" placeholder="function(data, col, colIndex, groupRowIndex, groupData, printData, rowIndex, visibleData){ return [1,1] }" class="auto-submit"></textarea>\n        </div>\n    </div>'), this.target;
      }, t.prototype.getValue = function () {
        var t = this.target.find("textarea").val();
        if (t) return t;
      }, t.prototype.setValue = function (t) {
