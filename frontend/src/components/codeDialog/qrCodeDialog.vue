      ...
      <v-card :title="$t('system.page.preView')">
        <v-card-text>
          <div class="print-area-container">
            <div class="print-area-scroll">
              <div id="printArea" class="printArea" :style="{ 'grid-template-columns': `repeat(${data.rowsNumber},1fr)` }">
        ...
        <v-card-actions class="justify-space-between">
          <div class="row-number-input">
            <v-text-field v-model.number="data.rowsNumber" hide-details="auto" :label="$t('system.page.rowsNumber')" width="300px"></v-text-field>
          </div>
