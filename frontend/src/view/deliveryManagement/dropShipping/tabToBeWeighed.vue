<template>
  <div class="operateArea">
    <v-row no-gutters>
      ...
      <v-col cols="3" class="col">
        ...
        <tooltip-btn icon="mdi-weight" :tooltip-text="$t('wms.dropShipping.weigh')" @click="method.handleWeigh"> </tooltip-btn> -->
  ...
  >
        ...
        <template #default="{ row }">
          <div style="width: 100%; display: flex; justify-content: center">
            ...
            <!-- <tooltip-btn
              :flat="true"
              icon="mdi-weight"
              :tooltip-text="$t('wms.dropShipping.weigh')"
    ...
    <WeightConfirm
      :show-dialog="data.showDialog"
      :dialog-title="$t('wms.dropShipping.weigh')"
      :is-weight="true"
...
import { getToBeWeighed, handleWeigh } from '@/api/wms/dropShipping'
...
const data = reactive({
  ...
  dialogWeightUnit: '',
  defaultWeight: 0,
  weighedRow: ref<DropShippingDetailVO>(),
  searchForm: {
    dispatch_no: '',
    customer_name: '',
    spu_name: ''
...
const method = reactive({
  ...
  exportTable: () => {
    ...
    exportData({
      table: $table,
      filename: i18n.global.t('wms.dropShipping.toBeWeighed'),
