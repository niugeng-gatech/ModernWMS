<template>
  ...
  >
    <vxe-table ref="xTable" :column-config="{ minWidth: '100px' }" :data="data.tableData" :height="tableHeight" align="center">
      ...
      <!-- <vxe-column field="dispatch_status" :title="$t('wms.dropShipping.dispatch_status')"></vxe-column> -->
...
import { getPreShipment } from '@/api/wms/dropShipping'
...
const method = reactive({
  ...
  exportTable: () => {
    ...
    exportData({
      table: $table,
      filename: i18n.global.t('wms.dropShipping.preShipment'),
