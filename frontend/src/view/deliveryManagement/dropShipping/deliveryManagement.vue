...
const tabsConfig = [
  {
    ...
    tabName: i18n.global.t('wms.dropShipping.shipment')
  },
  {
    value: 'tabPreShipment',
    icon: 'mdi-list-box-outline',
    tabName: i18n.global.t('wms.dropShipping.preShipment')
  },
  {
    value: 'tabNewShipment',
    icon: 'mdi-list-box',
    tabName: i18n.global.t('wms.dropShipping.newShipment')
  },
  {
    value: 'tabGoodsToBePicked',
    icon: 'mdi-dolly',
    tabName: i18n.global.t('wms.dropShipping.goodsToBePicked')
  },
  {
    value: 'tabPicked',
    icon: 'mdi-human-dolly',
    tabName: i18n.global.t('wms.dropShipping.picked')
  },
  // {
  //   value: 'tabToBePackaged',
  //   icon: 'mdi-package-variant',
  //   tabName: i18n.global.t('wms.dropShipping.toBePackaged')
  // },
  {
    value: 'tabPackaged',
    icon: 'mdi-package-variant',
    // icon: 'mdi-package-variant-closed-check',
    tabName: i18n.global.t('wms.dropShipping.packaged')
  },
  // {
  //   value: 'tabToBeWeighed',
  //   icon: 'mdi-basket-fill',
  //   tabName: i18n.global.t('wms.dropShipping.toBeWeighed')
  // },
  {
    value: 'tabWeighed',
    icon: 'mdi-basket-fill',
    // icon: 'mdi-weight',
    tabName: i18n.global.t('wms.dropShipping.weighed')
  },
  // {
  //   value: 'tabToBeDelivered',
  //   icon: 'mdi-send-outline',
  //   tabName: i18n.global.t('wms.dropShipping.toBeDelivered')
  // },
  {
    value: 'tabDelivered',
    icon: 'mdi-send-outline',
    // icon: 'mdi-send',
    tabName: i18n.global.t('wms.dropShipping.outOfWarehouse')
  },
  {
    value: 'tabSignIn',
    icon: 'mdi-check-circle',
    tabName: i18n.global.t('wms.dropShipping.signedIn')
  }
]
