  ...
  <div class="operateArea">
    <v-row no-gutters>
      ...
      <v-col cols="3" class="col">
        ...
        <tooltip-btn icon="mdi-cube-send" :tooltip-text="$t('wms.dropShipping.delivery')" @click="method.handleDeliver"> </tooltip-btn> -->
        ...
        <template #default="{ row }">
          <div style="width: 100%; display: flex; justify-content: center">
            ...
            <!-- <tooltip-btn
              :flat="true"
              icon="mdi-cube-send"
              :tooltip-text="$t('wms.dropShipping.delivery')"
...
import { DropShippingDetailVO } from '@/types/DeliveryManagement/DropShipping'
import { PAGE_SIZE, PAGE_LAYOUT, DEFAULT_PAGE_SIZE } from '@/constant/vxeTable'
import { hookComponent } from '@/components/system'
import { getToBeDelivery, handleDelivery } from '@/api/wms/dropShipping'
...
const method = reactive({
  ...
  exportTable: () => {
    ...
    exportData({
      table: $table,
      filename: i18n.global.t('wms.dropShipping.toBeDelivered'),
