<template>
  ...
  >
    <vxe-table ref="xTable" :column-config="{ minWidth: '100px' }" :data="data.tableData" :height="tableHeight" align="center">
      ...
      <vxe-column field="unpicked_qty" :title="$t('wms.dropShipping.unpicked_qty')"></vxe-column>
      <vxe-column field="picked_qty" :title="$t('wms.dropShipping.picked_qty')"></vxe-column>
...
import { hookComponent } from '@/components/system'
    import { getGoodsToBePicked } from '@/api/wms/dropShipping'
...
const method = reactive({
  ...
  exportTable: () => {
    ...
    exportData({
      table: $table,
      filename: i18n.global.t('wms.dropShipping.goodsToBePicked'),
