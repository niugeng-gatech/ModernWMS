          ...
          <div id="printArea" class="printArea">
            <div class="printTopContainer">
              ...
              <div class="printLabel" style="flex: 1">
                <div><span class="labelTitle">商品编码:</span> &nbsp;{{ data.printData.spu_code }}</div>
                <div><span class="labelTitle">商品名称:</span> &nbsp;{{ data.printData.spu_name }}</div>
                <div><span class="labelTitle">规格编码:</span> &nbsp;{{ data.printData.sku_code }}</div>
                <div><span class="labelTitle">规格名称:</span> &nbsp;{{ data.printData.sku_name }}</div>
              </div>
            </div>
          </div>
        </v-card-text>
