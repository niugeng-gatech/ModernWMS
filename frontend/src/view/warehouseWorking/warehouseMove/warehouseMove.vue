            ...
            <v-window-item>
              ...
              >
                  <vxe-table ref="xTable" :column-config="{ minWidth: '100px' }" :data="data.tableData" :height="tableHeight" align="center">
                      ...
                      <vxe-column field="orig_goods_warehouse"
                                  width="150px"
                                  :title="$t('wms.warehouseWorking.warehouseMove.orig_goods_warehouse')"></vxe-column>
                      <vxe-column field="orig_goods_location_name"
                                  width="150px"
                                  :title="$t('wms.warehouseWorking.warehouseMove.orig_goods_location_name')"></vxe-column>
                      <vxe-column field="dest_goods_warehouse"
                                  width="150px"
                                  :title="$t('wms.warehouseWorking.warehouseMove.dest_goods_warehouse')"></vxe-column>
                      <vxe-column field="dest_goods_location_name"
                                  width="150px"
                                  :title="$t('wms.warehouseWorking.warehouseMove.dest_goods_location_name')"></vxe-column>
                      ...
                      <vxe-column field="operate" :title="$t('system.page.operate')" width="250" :resizable="false" show-overflow>
                          <template #default="{ row }">
                              ...
                              <tooltip-btn :flat="true"
                                           ...
                                           @click="method.confirmMove(row)"></tooltip-btn>
                              <tooltip-btn :flat="true"
