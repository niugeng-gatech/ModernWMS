    ...
    public class StockmoveService : BaseService<StockmoveEntity>, IStockmoveService
    {
        ...
        public async Task<(int id, string msg)> AddAsync(StockmoveViewModel viewModel, CurrentUser currentUser)
        {
            ...
            var dispatch_group_datas = from dp in dispatch_DBSet.AsNoTracking()
                                       ...
                                       && dpp.goods_owner_id == entity.goods_owner_id && dpp.serial_number == entity.serial_number && dpp.goods_location_id == entity.orig_goods_location_id && dpp.sku_id == entity.sku_id
            ...
            var process_locked_group_datas = from pd in processdetail_DBSet
                                             ...
                                             && pd.goods_owner_id == entity.goods_owner_id && pd.serial_number == entity.serial_number
            ...
            var move_locked_group_datas = from sm in DbSet.AsNoTracking()
                                          ...
                                          && sm.goods_owner_id == entity.goods_owner_id && sm.serial_number == entity.serial_number
            ...
            var orig_stock = await
                (from sg in stock_DBSet.AsNoTracking()
                 ...
                 && sg.goods_owner_id == entity.goods_owner_id && sg.serial_number == entity.serial_number
                 select new
                 {
                     id = sg.id,
            ...
            var dest_stock = await stock_DBSet.FirstOrDefaultAsync(t => t.goods_owner_id == entity.goods_owner_id && t.serial_number == entity.serial_number && t.goods_location_id == entity.dest_goods_location_id && t.sku_id == entity.sku_id);
        ...
        public async Task<(bool flag, string msg)> Confirm(int id, CurrentUser currentUser)
        {
            ...
            entity.last_update_time = DateTime.Now;
            var orig_stock = await stock_DBSet.FirstOrDefaultAsync(t => t.goods_owner_id == entity.goods_owner_id && t.serial_number == entity.serial_number && t.goods_location_id == entity.orig_goods_location_id && t.sku_id == entity.sku_id);
            var dest_stock = await stock_DBSet.FirstOrDefaultAsync(t => t.goods_owner_id == entity.goods_owner_id && t.serial_number == entity.serial_number && t.goods_location_id == entity.dest_goods_location_id && t.sku_id != entity.sku_id);
            if (orig_stock != null)
            {
